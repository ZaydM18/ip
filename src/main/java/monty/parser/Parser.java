...
public class Parser {
    public static void processCommand(String userInput, ArrayList<Task> tasks, Ui ui) {
        try {
            ...
            switch (command) {
                ...
                case "todo":
                    if (argument.isEmpty()) throw new MontyException("Huh? You just left that description blank, friend.");
            ...
            ui.showError(" Your task number is out of range!");
        }
    }
